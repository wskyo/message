...
def repo_code():
	...
	CodeDir = "/local/build/genericapp/innovateapp/"
	ApkCloneDict = {}
...
def startJenkinsToBuild(appname):	
	jobname = "CreativeAPK-%s-release" % appname
	version = commands.getstatusoutput('/local/int_jenkins/misc/getCreativeApkNumber.py -appname %s' % appname)
	baseversion = commands.getstatusoutput('/local/int_jenkins/misc/getLastCreativeApkNumber.py -appname %s' % appname)
	addVersion = 'yes'
