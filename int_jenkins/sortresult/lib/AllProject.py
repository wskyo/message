...
class AllProject:
	...
	def run(self):
		...
		##add by jianbo.deng
		print "git clone version.git for version number ........."
		print "git clone %s version" % versionGit
		...
		##add by jianbo.deng 
		print "git clone %s manifest " % manifestGit

		isNeedCheckPersoIncompatible = False
		isPersoIncompatible = False
		##add by jianbo.deng for test allproject.py
		...
		for oneManifest in self.getInputManifestFiles():
			###add by jianbo.deng
			print "self.getInputManifestFiles() ..... /local/tools_int/versiontool/lib "
			print self.getInputManifestFiles()
