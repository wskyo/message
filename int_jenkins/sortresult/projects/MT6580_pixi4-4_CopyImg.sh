...
if [ ${#version} -gt 4 ] || [[ ${version:2:1} =~ [N-Z] ]] ; then
   if [ -f flashtool/system.img ]; then ln -s flashtool/system.img Y${main}${BN}${sub}BS00.mbn; fi   
   if [ -f flashtool/secro.img ]; then  ln -s flashtool/secro.img X${main}0${perso}${sub}BS00.mbn; fi
   if [ -f flashtool/logo*.bin ]; then ln -s flashtool/logo*.bin L${main}0${perso}${sub}BS00.mbn; fi 
   if [ -f flashtool/userdata.img ]; then ln -s flashtool/userdata.img S${main}0${perso}${sub}BS00.mbn; fi  
fi
...
if [ -f flashtool/proinfo.bin ]; then ln -s flashtool/proinfo.bin O${main}0${perso}${sub}BS00.mbn; fi
