...
cp ${builddir}/out/target/product/${project}/MT*_Android_scatter.txt ${releasedir}
...
cp ${builddir}/out/target/product/${project}/obj/CGEN/APDB_*_${APDBWEEK_NO} ${releasedir}
