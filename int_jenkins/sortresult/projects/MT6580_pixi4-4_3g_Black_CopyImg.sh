...
cp ${buildblackdir}/out/target/product/${project}/proinfo.bin ${releasedir}/flashtool
...
cp ${buildblackdir}/out/target/product/${project}/MTXGen/config/emmc.layout.xml ${releasedir}/mtxgen
