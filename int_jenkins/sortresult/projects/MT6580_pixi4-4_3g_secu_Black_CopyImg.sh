...
#cp ${buildblackdir}/out/target/product/${project}/signed_bin/* ${buildblackdir}/out/target/product/${project}/
...
cp ${buildblackdir}/out/target/product/${project}/signed_bin/proinfo-sign.bin ${relaseblackdir}/flashtool
...
cp ${buildblackdir}/out/target/product/${project}/signed_bin/mdrom-sign.img ${relaseblackdir}/flashtool
cp ${buildblackdir}/out/target/product/${project}/tct_fota_meta.zip ${relaseblackdir}/flashtool
...
if [ -f flashtool/MT65*_Android_scatter_emmc.txt ]; then ln -s flashtool/MT65*_Android_scatter_emmc.txt K${main:0:3}EMMCBS00.sca; fi
if [ -f flashtool/MT65*_Android_scatter.txt ]; then ln -s flashtool/MT65*_Android_scatter.txt K${main}0${perso}${sub}BS00.sca; fi
if [ -f flashtool/preloader_${project}.bin ]; then ln -s flashtool/preloader_${project}.bin P${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/DSP_BL ]; then ln -s flashtool/DSP_BL D${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/MBR ]; then ln -s flashtool/MBR M${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/EBR1 ]; then ln -s flashtool/EBR1 E${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/lk-sign.bin ]; then ln -s flashtool/lk-sign.bin U${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/boot-sign.img ]; then ln -s flashtool/boot-sign.img B${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/recovery-sign.img ]; then ln -s flashtool/recovery-sign.img R${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/EBR2 ]; then ln -s flashtool/EBR2 G${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/system-sign.img ]; then ln -s flashtool/system-sign.img Y${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/cache-sign.img ]; then ln -s flashtool/cache-sign.img H${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/userdata-sign.img ]; then ln -s flashtool/userdata-sign.img S${main}0${perso}${sub}BS00.mbn; fi
...
if [ -f flashtool/secro-sign.img ]; then ln -s flashtool/secro-sign.img W${main:0:2}0${main:3:1}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/logo.bin ]; then ln -s flashtool/logo-sign.bin L${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/mdrom.img ]; then ln -s flashtool/mdrom-sign.img C${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/EBR3 ]; then ln -s flashtool/EBR3 J${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/EBR4 ]; then ln -s flashtool/EBR4 N${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/fat.img ]; then ln -s flashtool/fat.img F${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/mobile_info-sign.img ]; then ln -s flashtool/mobile_info-sign.img I${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/APDB_MT6580* ]; then ln -s flashtool/APDB_MT6580* A${main}0${perso}${sub}BS00.db; fi
if [ -f flashtool/BPLGUInfoCustomAppSrcP* ]; then ln -s flashtool/BPLGUInfoCustomAppSrcP* O${main}0${perso}${sub}BS00.db; fi
if [ -f flashtool/proinfo-sign.bin ]; then ln -s flashtool/proinfo-sign.bin O${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/trustzone-sign.bin ]; then ln -s flashtool/trustzone-sign.bin T${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/tct_fota_meta.zip ]; then ln -s flashtool/tct_fota_meta.zip 7${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/_system.map ]; then ln -s flashtool/_system.map  8${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/simlock-sign.img ]; then  ln -s flashtool/simlock-sign.img X${main}0${perso}${sub}BS00.mbn; fi
