...
cp ${builddir}/out/target/product/${project}/obj/CGEN/APDB_MT6572_S01_L1.MP6_${APDBWEEK_NO} ${releasedir}
cp ${builddir}/modem/out_modem/BPLGUInfo* ${releasedir}/flashtool
cp ${builddir}/modem/mtk_rel/PIXI4_4_HSPA/DEFAULT/tst/database/MCDDLL.dll ${releasedir}
cp ${builddir}/modem/mtk_rel/PIXI4_4_HSPA/DEFAULT/tst/database/mcddll.dll ${releasedir}
APDBWEEK_NO=`cat ${builddir}/device/jrdchz/${project}/ProjectConfig.mk | awk '{print $3}' | grep ^W15`
