...
cp ${builddir}/out/target/product/${project}/MT65*_Android_scatter_emmc.txt ${releasedir} 
...
cp ${builddir}/out/target/product/${project}/obj/CGEN/APDB_MT6580_S01_L1.MP6_${APDBWEEK_NO} ${releasedir}
cp ${builddir}/modem/out_modem/BPLGUInfo* ${releasedir}
cp ${builddir}/modem/mtk_rel/PIXI3_5_HSPA/DEFAULT/tst/database/MCDDLL.dll ${releasedir}
cp ${builddir}/modem/mtk_rel/PIXI3_5_HSPA/DEFAULT/tst/database/mcddll.dll ${releasedir}
