...
cp ${buildblackdir}/out/target/product/${project}/signed_bin/md1rom-sign.img ${relaseblackdir}/flashtool
...
#if [ -f flashtool/secro-sign.img ]; then ln -s flashtool/secro-sign.img X${main:0:2}0${main:3:1}0${perso}${sub}BV00.mbn; fi
