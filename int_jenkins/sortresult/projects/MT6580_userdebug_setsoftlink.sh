...
#send "ln -s ../../flashtool/MBR M${main}0${perso}${sub}BV00.mbn\r"
#send "ln -s ../../flashtool/EBR1 E${main}0${perso}${sub}BV00.mbn\r"
...
send "ln -s ../../flashtool/recovery.img R${main}0${perso}${sub}BV00.mbn\r"
#send "ln -s ../../flashtool/EBR2 G${main}0${perso}${sub}BV00.mbn\r"
send "ln -s ../../flashtool/system.img Y${main}0${perso}${sub}BV00.mbn\r"
send "ln -s ../../flashtool/cache.img H${main}0${perso}${sub}BV00.mbn\r"
send "ln -s ../../flashtool/userdata.img S${main}0${perso}${sub}BV00.mbn\r"
...
send "ln -s ../../flashtool/mobile_info.img I${main}0${perso}${sub}BV00.mbn\r"
send "ln -s ../../APDB_MT6580_S01_L1.MP6_W15.42 A${main}0${perso}${sub}BV00.db\r"
