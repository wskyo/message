...
cp ${builddir}/out/target/product/${project}/obj/CODEGEN/cgen/APDB_MT6572_S01_KK1.MP6_ ${releasedir}/flashtool
...
cp ${builddir}/mediatek/custom/common/modem/jrdhz72_we_72_s1_kk/mcddll.dll ${releasedir}/flashtool
cp ${builddir}/modem/mtk_rel/${project}_HSPA/DEFAULT/tst/database/MCDDLL.dll ${releasedir}/flashtool
cp ${builddir}/modem/mtk_rel/${project}_HSPA/DEFAULT/tst/database/mcddll.dll ${releasedir}/flashtool
...
case $band in
    ...
    "panasonic" )
        BN='PA';;
    * )
        echo "No such band! (EU|US|US0|US1|US2|US3|US4|2M|AWS|LATAM2G|LATAM3G|panasonic)"
        exit 0;;
esac
