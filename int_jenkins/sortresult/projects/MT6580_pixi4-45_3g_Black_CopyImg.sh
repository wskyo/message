...
APDBWEEK_NO=`cat ${buildblackdir}/device/jrdchz/${project}/ProjectConfig.mk | awk '{print $3}' | grep W15`
...
if [ -f flashtool/lk.bin ]; then ln -s flashtool/lk.bin U${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/boot.img ]; then ln -s flashtool/boot.img B${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/recovery.img ]; then ln -s flashtool/recovery.img R${main}0${perso}${sub}BS00.mbn; fi
...
if [ -f flashtool/cache.img ]; then ln -s flashtool/cache.img H${main}0${perso}${sub}BS00.mbn; fi
...
#if [ -f flashtool/custpack.img ]; then ln -s flashtool/custpack.img C${main}${BN}${sub}BS00.mbn; fi   
#if [ -f flashtool/secro.img ]; then ln -s flashtool/secro.img X${main:0:2}0${main:3:1}0${perso}${sub}BS00.mbn; fi
#if [ -f flashtool/logo_jrd.bin ]; then ln -s flashtool/logo_jrd.bin L${main}0${perso}${sub}BS00.mbn; fi
...
if [ -f flashtool/mobile_info.img ]; then ln -s flashtool/mobile_info.img I${main}0${perso}${sub}BS00.mbn; fi
