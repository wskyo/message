...
cp ${builddir}/out/target/product/${project}/signed_bin/custpack-sign.img ${releasedir}/flashtool
...
#cp ${builddir}/mediatek/custom/common/modem/jrdhz72_we_72_s1_kk/mcddll.dll ${releasedir}/flashtool
cp ${builddir}/modem/mtk_rel/PIXI3_5_HSPA/DEFAULT/tst/database/MCDDLL.dll ${releasedir}/flashtool
cp ${builddir}/modem/mtk_rel/PIXI3_5_HSPA/DEFAULT/tst/database/mcddll.dll ${releasedir}/flashtool
