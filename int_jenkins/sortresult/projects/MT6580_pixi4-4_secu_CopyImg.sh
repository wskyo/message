...
cp ${builddir}/out/target/product/${project}/signed_bin/simlock-sign.img ${releasedir}/flashtool
...
cp ${builddir}/out/target/product/${project}/signed_bin/mdrom-sign.img ${releasedir}/flashtool
...
#if [ -f flashtool/system.img ]; then ln -s flashtool/system.img Y${main}0${perso}${sub}BS00.mbn; fi
...
if [ ${#version} -gt 4 ] || [[ ${version:2:1} =~ [N-Z] ]] ; then
   if [ -f flashtool/system-sign.img ]; then ln -s flashtool/system-sign.img Y${main}${BN}${sub}BS00.mbn; fi   
   if [ -f flashtool/mdrom-sign.img ]; then  ln -s flashtool/mdrom-sign.img C${main}0${perso}${sub}BS00.mbn; fi
   if [ -f flashtool/logo*-sign.bin ]; then ln -s flashtool/logo*-sign.bin L${main}0${perso}${sub}BS00.mbn; fi 
   #if [ -f flashtool/userdata.img ]; then ln -s flashtool/userdata.img S${main}0${perso}${sub}BS00.mbn; fi 
...
if [ -f flashtool/BPLGUInfoCustomAppSrcP* ]; then ln -s flashtool/BPLGUInfo* O${main}0${perso}${sub}BS00.db; fi
...
if [ -f flashtool/target_files_extract.zip ]; then ln -s flashtool/target_files_extract.zip 7${main}0${perso}${sub}BS00.mbn; fi
if [ -f flashtool/secro-sign.img ]; then ln -s flashtool/secro-sign.img W${main}0${perso}${sub}BS00.mbn; fi
