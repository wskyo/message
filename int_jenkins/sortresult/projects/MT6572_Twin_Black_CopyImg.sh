...
cp ${buildblackdir}/out/target/product/${project}/logo_jrd.bin ${relaseblackdir}/flashtool
...
cp ${buildblackdir}/mediatek/custom/common/modem/mt6572_demo_hspa_gemini/MCDDLL.dll ${relaseblackdir}/flashtool
cp ${buildblackdir}/mediatek/custom/common/modem/mt6572_demo_hspa_gemini/mcddll.dll ${relaseblackdir}/flashtool
cp ${buildblackdir}/*_wimdata_ng/wcustores/Modem/${band}/MCDDLL.dll ${relaseblackdir}/flashtool
cp ${buildblackdir}/*_wimdata_ng/wcustores/Modem/${band}/mcddll.dll ${relaseblackdir}/flashtool
