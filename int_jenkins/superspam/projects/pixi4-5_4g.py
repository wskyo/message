...
class project(AllProjectNewAlm):
	...
	def initConfFromXls(self, conf):
		...
		self.ProjectConfig = commands.getoutput('/local/int_jenkins/bin/MT6735_X_GetVerInfo '+ versionStr[0:3]+'X -All').split('\n')
		argvList = []
		...
		argvList.extend(['-owner','yinfang.lai_xiaofen.zhong'])
	...
	def getNameRule(self):
		return 'Pixi4-5-4g-Software_Naming_Rule_v0.1.xls'
	...
	def getModemVersion(self, version):
		...
		if(version[1:2] == '7' or version[1:2] == 'X'):
			return 'MOLY.LR9.W1444.MD.LWTG.MP.V8'
