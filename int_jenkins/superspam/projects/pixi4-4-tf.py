...
class project(AllProjectNewAlm):
	...
	def getNameRule(self):
		return 'Pixi4-4-TF-Software_Naming_Rule_v1.2.xls'
	...
	def doMiniTestAddFromProject(self, worksheet, conf, checkListConf):
		...
		self.miniTestCheckItem(worksheet, conf, checkListConf, 'DB files', 'Go to Teleweb,make sure that two DB files exist in this version')
		return
