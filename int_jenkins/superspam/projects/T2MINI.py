...
class project(AllProjectNewAlm):
	...
	def initConfFromXls(self, conf):
		...
		if(versionStr[-2] >= 'U' and not versionStr.__contains__('-')):
			self.BAND = conf.getConf('BAND', 'which BAND version to deliver? <CN|EU1|EU2|US1|US2|2M|AWS|2G|LATAM3G|LATAM2G|US0-1S|US0-2S|US1-1S|US1-2S|US2-2S|US3-1S|US3-2S|US4-1S|US4-2S|US5-2S|US5-1S|US_TF-1S|US_TF-2S|CN>')
	...
	def getNameRule(self):
		return 'T2-MINI-Software_Naming_Rule_v0.2.xls'
