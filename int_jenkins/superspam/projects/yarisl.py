...
class project(AllProjectNew):
	...
	def getNameRule(self):
		return 'YarisL_Software_NAMING_RULE.xls'
	...
	def doMiniTestAddFromProject(self, worksheet, conf, checkListConf):
		self.miniTestCheckItem(worksheet, conf, checkListConf, 'openmtklog', 'Use *#*#825364#*#* and *#*#82533284#*#* to check mtklog open or not.')
	...
	def getModemVersion(self, version):
		...
		if(version[1:2] == '7' or version[1:2] == 'X'):
			return 'MT6572_S00_MOLY_WR8_W1315_MD_WG_MP_V1_F1'
