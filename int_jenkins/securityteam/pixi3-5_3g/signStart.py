...
class sign_apk():
	...
	def replace(self):
		...
		docmd('cp /local/int_jenkins/securityteam/pixi3-5_3g/TCL_ReleaseKeys.zip build/target/product/security/')
	...
	def build(self):
   		...
   		docmd('cp out/target/product/pixi3_5/custpack.img out/target/product/pixi3_5/custpack.img_unsign')
		docmd('cp out/target/product/pixi3_5/system.img out/target/product/pixi3_5/system.img_unsign')
		docmd('cp out/target/product/pixi3_5/recovery.img out/target/product/pixi3_5/recovery.img_unsign')
		docmd('cp out/target/product/pixi3_5/boot.img out/target/product/pixi3_5/boot.img_unsign')
		docmd('cp out/target/product/pixi3_5/cache.img out/target/product/pixi3_5/cache.img_unsign')
		docmd('cp out/target/product/pixi3_5/userdata.img out/target/product/pixi3_5/userdata.img_unsign')
                #end
                docmd('rm out/target/product/pixi3_5/system/plugin/Signatures/mplugin_guard.xml')
                docmd('cp /local/int_jenkins/securityteam/pixi3-5_3g/mplugin_guard.xml out/target/product/pixi3_5/system/plugin/Signatures/mplugin_guard.xml')
		#docmd('source build/envsetup.sh && lunch full_pixi3_5-user && make dist')
		docmd('make dist -j24')
	...
	def signapk(self):
		...
		child = pexpect.spawn('./misc_sign_custpack_apks.py out/dist/full_pixi3_5-target_*.zip out/dist/sign_target_apks.zip')
		...
		os.chdir(self.tmpdir)
		#docmd('mv out/target/product/pixi3_5/custpack.img out/target/product/pixi3_5/custpack.img_unsign')
		#docmd('mv out/target/product/pixi3_5/system.img out/target/product/pixi3_5/system.img_unsign')
		#docmd('mv out/target/product/pixi3_5/recovery.img out/target/product/pixi3_5/recovery.img_unsign')
		#docmd('mv out/target/product/pixi3_5/boot.img out/target/product/pixi3_5/boot.img_unsign')
		docmd('cp out/dist/sign_img/custpack.img out/target/product/pixi3_5/')
		docmd('cp out/dist/sign_img/system.img out/target/product/pixi3_5/')
		docmd('cp out/dist/sign_img/recovery.img out/target/product/pixi3_5/')
		docmd('cp out/dist/sign_img/boot.img out/target/product/pixi3_5/')
		#docmd('perl mediatek/build/tools/jrd_magic.pl pixi3_5')
		docmd('perl vendor/jrdcom/build/jrdmagic/jrd_magic.pl pixi3_5')
...
if __name__ == "__main__":
	...
	#	sys.exit(1)
	dist = sign_apk(sys.argv[1],'pixi3-5_3g')
	#dist = sign_apk('')
	dist.build()
	dist.replace()
	dist.signapk()
