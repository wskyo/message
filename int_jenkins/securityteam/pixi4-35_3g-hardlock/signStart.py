...
class sign_apk():
	...
	def replace(self):
		...
		docmd('cp /local/int_jenkins/securityteam/pixi4-35_3g/TCL_ReleaseKeys.zip build/target/product/security/')
	...
	def build(self):
   		...
   		#docmd('cp out/target/product/pixi4_35/custpack.img out/target/product/pixi4_35/custpack.img_unsign')
		docmd('cp out/target/product/pixi4_35/system.img out/target/product/pixi4_35/system.img_unsign')
		docmd('cp out/target/product/pixi4_35/recovery.img out/target/product/pixi4_35/recovery.img_unsign')
		docmd('cp out/target/product/pixi4_35/boot.img out/target/product/pixi4_35/boot.img_unsign')
		docmd('cp out/target/product/pixi4_35/cache.img out/target/product/pixi4_35/cache.img_unsign')
		docmd('cp out/target/product/pixi4_35/userdata.img out/target/product/pixi4_35/userdata.img_unsign')
                #end
                docmd('rm out/target/product/pixi4_35/system/plugin/Signatures/mplugin_guard.xml')
                docmd('cp /local/int_jenkins/securityteam/pixi4-35_3g/mplugin_guard.xml out/target/product/pixi4_35/system/plugin/Signatures/mplugin_guard.xml')
		#docmd('source build/envsetup.sh && lunch full_pixi4_35-user && make dist')
		docmd('make dist SW_HARD_LOCK=true -j24 > log.txt')
	...
	def signapk(self):
		...
		child = pexpect.spawn('./misc_sign_custpack_apks.py out/dist/full_pixi4_35-target_*.zip out/dist/sign_target_apks.zip')
		...
		os.chdir(self.tmpdir)
		#docmd('mv out/target/product/pixi4_35/custpack.img out/target/product/pixi4_35/custpack.img_unsign')
		#docmd('mv out/target/product/pixi4_35/system.img out/target/product/pixi4_35/system.img_unsign')
		#docmd('mv out/target/product/pixi4_35/recovery.img out/target/product/pixi4_35/recovery.img_unsign')
		#docmd('mv out/target/product/pixi4_35/boot.img out/target/product/pixi4_35/boot.img_unsign')
		#docmd('cp out/dist/sign_img/custpack.img out/target/product/pixi4_35/')
		docmd('cp out/dist/sign_img/system.img out/target/product/pixi4_35/')
		docmd('cp out/dist/sign_img/recovery.img out/target/product/pixi4_35/')
		docmd('cp out/dist/sign_img/boot.img out/target/product/pixi4_35/')
		docmd('cp out/dist/sign_img/cache.img out/target/product/pixi4_35/')
		docmd('cp out/dist/sign_img/userdata.img out/target/product/pixi4_35/')
		#docmd('perl mediatek/build/tools/jrd_magic.pl pixi4_35')
		docmd('perl vendor/jrdcom/build/jrdmagic/jrd_magic.pl pixi4_35')
...
if __name__ == "__main__":
	...
	#	sys.exit(1)
	dist = sign_apk(sys.argv[1],'pixi4-35_3g')
	#dist = sign_apk('')
	dist.build()
	dist.replace()
	dist.signapk()
