...
class sign_apk():
	...
	def replace(self):
		...
		docmd('cp /local/int_jenkins/securityteam/pixi3-5_3g-relook/TCL_ReleaseKeys.zip build/target/product/security/')
	...
	def build(self):
   		...
   		docmd('cp out/target/product/pixi3_5_relook/custpack.img out/target/product/pixi3_5_relook/custpack.img_unsign')
		docmd('cp out/target/product/pixi3_5_relook/system.img out/target/product/pixi3_5_relook/system.img_unsign')
		docmd('cp out/target/product/pixi3_5_relook/recovery.img out/target/product/pixi3_5_relook/recovery.img_unsign')
		docmd('cp out/target/product/pixi3_5_relook/boot.img out/target/product/pixi3_5_relook/boot.img_unsign')
		docmd('cp out/target/product/pixi3_5_relook/cache.img out/target/product/pixi3_5_relook/cache.img_unsign')
		docmd('cp out/target/product/pixi3_5_relook/userdata.img out/target/product/pixi3_5_relook/userdata.img_unsign')
                #end
                docmd('rm out/target/product/pixi3_5_relook/system/plugin/Signatures/mplugin_guard.xml')
                docmd('cp /local/int_jenkins/securityteam/pixi3-5_3g-relook/mplugin_guard.xml out/target/product/pixi3_5_relook/system/plugin/Signatures/mplugin_guard.xml')
		#docmd('source build/envsetup.sh && lunch full_pixi3_5_relook-user && make dist')
		docmd('make dist -j16')
	...
	def signapk(self):
		...
		child = pexpect.spawn('./misc_sign_custpack_apks.py out/dist/full_pixi3_5_relook-target_*.zip out/dist/sign_target_apks.zip')
		...
		os.chdir(self.tmpdir)
		#docmd('mv out/target/product/pixi3_5_relook/custpack.img out/target/product/pixi3_5_relook/custpack.img_unsign')
		#docmd('mv out/target/product/pixi3_5_relook/system.img out/target/product/pixi3_5_relook/system.img_unsign')
		#docmd('mv out/target/product/pixi3_5_relook/recovery.img out/target/product/pixi3_5_relook/recovery.img_unsign')
		#docmd('mv out/target/product/pixi3_5_relook/boot.img out/target/product/pixi3_5_relook/boot.img_unsign')
		docmd('cp out/dist/sign_img/custpack.img out/target/product/pixi3_5_relook/')
		docmd('cp out/dist/sign_img/system.img out/target/product/pixi3_5_relook/')
		docmd('cp out/dist/sign_img/recovery.img out/target/product/pixi3_5_relook/')
		docmd('cp out/dist/sign_img/boot.img out/target/product/pixi3_5_relook/')
		#docmd('perl mediatek/build/tools/jrd_magic.pl pixi3_5_relook')
		docmd('perl vendor/jrdcom/build/jrdmagic/jrd_magic.pl pixi3_5_relook')
...
if __name__ == "__main__":
	...
	#	sys.exit(1)
	dist = sign_apk(sys.argv[1],'pixi3-5_3g-relook')
	#dist = sign_apk('')
	dist.build()
	dist.replace()
	dist.signapk()
