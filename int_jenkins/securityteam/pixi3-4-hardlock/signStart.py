...
class sign_apk():
	...
	def build(self):
		...
		docmd('./makeMtk -t -o=TARGET_BUILD_VARIANT=user,SW_HARD_LOCK=true pixi3_4 dist')
	...
	def signapk(self):
		...
		child = pexpect.spawn('./misc_sign_custpack_apks.py out/dist/pixi3_4-target_*.zip out/dist/sign_target_apks.zip')
		...
		os.chdir(self.tmpdir)
		docmd('mv out/target/product/pixi3_4/custpack.img out/target/product/pixi3_4/custpack.img_unsign')
		docmd('mv out/target/product/pixi3_4/system.img out/target/product/pixi3_4/system.img_unsign')
		docmd('mv out/target/product/pixi3_4/recovery.img out/target/product/pixi3_4/recovery.img_unsign')
		docmd('mv out/target/product/pixi3_4/boot.img out/target/product/pixi3_4/boot.img_unsign')
		docmd('cp out/dist/sign_img/custpack.img out/target/product/pixi3_4/')
		docmd('cp out/dist/sign_img/system.img out/target/product/pixi3_4/')
		docmd('cp out/dist/sign_img/recovery.img out/target/product/pixi3_4/')
		docmd('cp out/dist/sign_img/boot.img out/target/product/pixi3_4/')
		docmd('perl mediatek/build/tools/jrd_magic.pl pixi3_4')
...
if __name__ == "__main__":
	...
	#	sys.exit(1)
	dist = sign_apk(sys.argv[1],'pixi3-4')
	#dist = sign_apk('')
	dist.build()
	dist.replace()
	dist.signapk()
