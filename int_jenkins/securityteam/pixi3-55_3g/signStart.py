...
class sign_apk():
	...
	def replace(self):
		docmd('cp /local/int_jenkins/securityteam/pixi3-55_3g/misc_sign_custpack_apks.py .')
		...
		docmd('cp /local/int_jenkins/securityteam/pixi3-55_3g/TCL_ReleaseKeys.zip build/target/product/security/')
	...
	def build(self):
   		...
   		docmd('cp out/target/product/pixi3_55/custpack.img out/target/product/pixi3_55/custpack.img_unsign')
		docmd('cp out/target/product/pixi3_55/system.img out/target/product/pixi3_55/system.img_unsign')
		docmd('cp out/target/product/pixi3_55/recovery.img out/target/product/pixi3_55/recovery.img_unsign')
		docmd('cp out/target/product/pixi3_55/boot.img out/target/product/pixi3_55/boot.img_unsign')
		docmd('cp out/target/product/pixi3_55/cache.img out/target/product/pixi3_55/cache.img_unsign')
		docmd('cp out/target/product/pixi3_55/userdata.img out/target/product/pixi3_55/userdata.img_unsign')
                #end
                docmd('rm out/target/product/pixi3_55/system/plugin/Signatures/mplugin_guard.xml')
                docmd('cp /local/int_jenkins/securityteam/pixi3-55_3g/mplugin_guard.xml out/target/product/pixi3_55/system/plugin/Signatures/mplugin_guard.xml')
		#docmd('source build/envsetup.sh && lunch full_pixi3_55-user && make dist')
		docmd('make dist')
	...
	def signapk(self):
		...
		child = pexpect.spawn('./misc_sign_custpack_apks.py out/dist/full_pixi3_55-target_*.zip out/dist/sign_target_apks.zip')
		...
		os.chdir(self.tmpdir)
		#docmd('mv out/target/product/pixi3_55/custpack.img out/target/product/pixi3_55/custpack.img_unsign')
		#docmd('mv out/target/product/pixi3_55/system.img out/target/product/pixi3_55/system.img_unsign')
		#docmd('mv out/target/product/pixi3_55/recovery.img out/target/product/pixi3_55/recovery.img_unsign')
		#docmd('mv out/target/product/pixi3_55/boot.img out/target/product/pixi3_55/boot.img_unsign')
		docmd('cp out/dist/sign_img/custpack.img out/target/product/pixi3_55/')
		docmd('cp out/dist/sign_img/system.img out/target/product/pixi3_55/')
		docmd('cp out/dist/sign_img/recovery.img out/target/product/pixi3_55/')
		docmd('cp out/dist/sign_img/boot.img out/target/product/pixi3_55/')
          	docmd('perl vendor/jrdcom/build/jrdmagic/jrd_magic.pl pixi3_55')
...
if __name__ == "__main__":
	...
	#	sys.exit(1)
	dist = sign_apk(sys.argv[1],'pixi3_55')
	#dist = sign_apk('')
	dist.build()
	dist.replace()
	dist.signapk()
